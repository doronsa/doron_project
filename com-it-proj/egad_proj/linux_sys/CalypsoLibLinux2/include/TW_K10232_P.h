...
{   //                                       In                                   Out
	...
	e_CmdK10_ClySam_DetectCard=61,     	       // [IN] St_ClySam_DetectCard,             [OUT] void
	e_CmdK10_ClySam_Reset=62,                  // [IN] St_ClySam_ResetReq,               [OUT] St_ClySam_ResetResp
	e_CmdK10_ClySam_GetType=63,                // [IN] St_ClySam_GetTypeReq,             [OUT] St_ClySam_GetTypeResp
	e_CmdK10_ClySam_GetSerNum=64,              // [IN] St_ClySam_SerNumReq,              [OUT] St_ClySam_SerNumResp
	e_CmdK10_ClySam_Unlock=65,                 // [IN] St_ClySam_UnlockReq,              [OUT] St_ClySam_UnlockResp       
	e_CmdK10_ClySam_ReadData=66,               // [IN] St_ClySam_ReadDataReq,            [OUT] St_ClySam_ReadDataResp       
              
	e_CmdK10_ClyCard_Init=67,                  // [IN] St_ClyCard_initReq,               [OUT] St_ClyCard_SerNumReq 
	e_CmdK10_ClyCard_GetSerNum=68,             // [IN] St_ClyCard_SerNumReq,             [OUT] St_ClyCard_SerNumResp 
	e_CmdK10_ClyCard_DetectCard=69,            // [IN] St_ClyCard_DetectCard,            [OUT] void 
	e_CmdK10_ClyCard_EjectCard=70,             // [IN] St_ClyCard_EjectCard,             [OUT] void 
	e_CmdK10_ClyCard_Reset=71,                 // [IN] St_ClyCard_ResetReq,              [OUT] St_ClyCard_ResetResp 
	e_CmdK10_ClyCard_StartWorkWithCard=72,	   // [IN] St_ClyCard_StartWorkWithCardReq,  [OUT] St_ClyCard_StartWorkWithCardResp 
	e_CmdK10_ClyCard_ReadRecord=73,		       // [IN] St_ClyCard_ReadRecordReq,         [OUT] St_ClyCard_ReadRecordResp 
	e_CmdK10_ClyCard_WriteRecord=74,		   // [IN] St_ClyCard_WriteRecordReq,        [OUT] St_ClyCard_WriteRecordResp 
	e_CmdK10_ClyCard_UpdateRecord=75,		   // [IN] St_ClyCard_UpdateRecordReq,       [OUT] St_ClyCard_UpdateRecordResp 
	e_CmdK10_ClyCard_IncreaseDecrease=76,	   // [IN] St_ClyCard_IncDecCntRecordReq,    [OUT] St_ClyCard_IncDecCntRecordResp 
	e_CmdK10_ClyCard_Invalidate=77,		       // [IN] St_ClyCard_InvalidateReq,         [OUT] St_ClyCard_InvalidateResp
      
	e_CmdK10_ClyCard_TestReadWrite=78,		   // [IN] St_ClyCard_TestReadWriteReq,      [OUT] St_ClyCard_TestReadWriteResp 
      
	e_CmdK10_7816_ContactlessDetect=79,        // [IN] void,                             [OUT] void
	e_CmdK10_7816_GetCardResetInfo=80,         // [IN] St_7816_GetCardResetInfoReq,      [OUT] St_7816_GetCardResetInfoResp
	e_CmdK10_7816_ContactlessForgetCard=81,    // [IN] void,                             [OUT] void
	e_CmdK10_7816_CheckCardComm=82,            // [IN] St_7816_CheckCardCommReq,         [OUT] void

	e_CmdK10_ClySession_OpenSecureSession=83,  // [IN] St_ClyCard_OpenSecureSessionReq , [OUT] St_ClyCard_OpenSecureSessionResp
	e_CmdK10_ClySession_CloseSecureSession=84, // [IN] St_ClyCard_CloseSecureSessionReq, [OUT] St_ClyCard_CloseSecureSessionResp
	
	e_CmdK10_ClyApp_PingTest=85,	           // [IN] void,                             [OUT] void
    e_CmdK10_ClyApp_TxDataTest=86,             // [IN] St_ClyApp_TxDataReq,              [OUT] St_ClyApp_TxDataResp
    e_CmdK10_ClyApp_IsCardIn=87,	           // [IN] void,                             [OUT] St_ClyApp_SmartCardData
	e_CmdK10_ClySam_GetSerNum_Sam_Egged_Sign=88, // [IN] St_ClySam_SerNumReq,            [OUT] St_ClySam_SerNumResp
	e_CmdK10_Test_Reader,                         //[IN] St_TestReaderRequest             [OUT] St_TestReaderResults
