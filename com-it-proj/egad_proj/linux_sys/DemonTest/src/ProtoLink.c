...
e_ComResult Protocol_SEND_COM_PROC(int p_handler,   // [IN]
    ...
    )
{
    ...
    //print_buffer1(p_Data,us_size);
    Err = SendCommandToK10( p_handler, p_Data, us_size, (us_size * 10)); // Write to the UART
    if(Err > 0)
       ComRes =  e_ComOk;
