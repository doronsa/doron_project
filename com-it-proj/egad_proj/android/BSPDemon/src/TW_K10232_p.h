...
//doron packed for linux
#define  TR_PACK_PREFIX __attribute__ ((packed))
...
{   //                                       In                                   Out
	...
	e_CmdK10_ClyCard_EjectCard,             //70 [IN] St_ClyCard_EjectCard,             [OUT] void
	...
	e_CmdK10_7816_GetCardResetInfo,         //80 [IN] St_7816_GetCardResetInfoReq,      [OUT] St_7816_GetCardResetInfoResp
    ...
    e_CmdDCUinit=100,						//[IN] DCU usb driver key
    // ----------------------------------------------------------------------------------------
...
struct __attribute__((__packed__)) TAG_St_K10_TestComm
{
    K_BYTE EchoTest[ECHO_SIZE_TEST];// The application should return the same information
};
typedef struct __attribute__((__packed__)) TAG_St_K10_TestComm St_K10_TestComm;
...
struct __attribute__((__packed__)) TAG_St_K10_BITResult
{
  K_BOOL RfIdOk;
  K_BOOL SamOk;
...
struct __attribute__((__packed__)) TAG_St_K10_BITResult St_K10_BITResult;
...
struct __attribute__((__packed__)) TAG_St_K10_DisplaySet
{
...
typedef struct __attribute__((__packed__)) TAG_St_K10_DisplaySet St_K10_DisplaySet;
...
struct __attribute__((__packed__)) TAG_St_K10_DisplayGet
{
  St_DisplayState dsp_Driver;
  St_DisplayState dsp_Psngr;
};
typedef struct __attribute__((__packed__)) TAG_St_K10_DisplayGet St_K10_DisplayGet;
...
typedef  struct TAG_St_K10_KeyboardCommandConfig St_K10_KeyboardCommandConfig;
...
typedef struct TAG_St_K10_KeyboardCommand St_K10_KeyboardCommand;
...
typedef struct TAG_St_K10_KeyboardCommandResponse St_K10_KeyboardCommandResponse;
...
typedef struct TAG_St_CmdK10_KeyboardGetKey St_CmdK10_KeyboardGetKey;
...
struct __attribute__((__packed__)) TAG_St_K10_PowerCommandGet
{
 K_DWORD Current24;
 K_BOOL Good24;
...
typedef struct __attribute__((__packed__)) TAG_St_K10_PowerCommandGet St_K10_PowerCommandGet;
...
struct __attribute__((__packed__)) TAG_St_K10_PowerCommandSet
{
	K_BYTE Channel;//e_PowerChannel
	K_BYTE Command;//e_PowerCommand
};
typedef struct __attribute__((__packed__)) TAG_St_K10_PowerCommandSet St_K10_PowerCommandSet;


//-------------------------------------------------------------------
//e_CmdK10_SensorCommandGet, St_K10_SensorCommandGet

struct __attribute__((__packed__)) TAG_St_K10_SensorCommandGet
{
...
typedef struct __attribute__((__packed__)) TAG_St_K10_SensorCommandGet St_K10_SensorCommandGet;
...
struct __attribute__((__packed__)) TAG_St_K10_SolenoidCommandSet
{
	K_BYTE SolenoidId;//e_SolenoidId
	K_BYTE SolenoidOperation;//e_SolenoidId
};
typedef struct __attribute__((__packed__)) TAG_St_K10_SolenoidCommandSet St_K10_SolenoidCommandSet;
...
struct __attribute__((__packed__)) TAG_St_PrinterCommandSet
{
...
typedef struct __attribute__((__packed__)) TAG_St_PrinterCommandSet St_PrinterCommandSet;
...
struct __attribute__((__packed__)) TAG_St_K10_LedCommandSet
{
...
typedef struct __attribute__((__packed__)) TAG_St_K10_LedCommandSet St_K10_LedCommandSet;

//-------------------------------------------------------------------
//e_CmdK10_SetParam,               St_K10Param                         

struct __attribute__((__packed__)) TAG_St_K10Param
{
...
typedef struct __attribute__((__packed__)) TAG_St_K10Param St_K10Param;
...
typedef struct __attribute__((__packed__)) TAG_St_K10_PeriodicMonitorPoll St_K10_PeriodicMonitorPoll,St_K10_PeriodicMonitorEvent;

//-------------------------------------------------------------------
//e_CmdK10_EventSensorChange=33,//           St_K10_EventSensorChange
//-------------------------------------------------------------------

struct __attribute__((__packed__)) TAG_St_K10_EventSensorChange
{
...
typedef struct __attribute__((__packed__)) TAG_St_K10_EventSensorChange St_K10_EventSensorChange;
...
struct __attribute__((__packed__)) TAG_St_K10_GetAppVersion
{
...
typedef struct __attribute__((__packed__)) TAG_St_K10_GetAppVersion St_K10_GetAppVersion;
//-------------------------------------------------------------------
//	e_CmdK10_DownLoad   St_K10_DownLoad
// buffer is long (2000 ms ) 
struct __attribute__((__packed__)) TAG_St_K10_DownLoad  // each buffer the loader write the buffer and return ack the timeout for the first buffer and last
{
	K_WORD AppVersion;  
...
typedef struct __attribute__((__packed__))  TAG_St_K10_DownLoad St_K10_DownLoad;

//-------------------------------------------------------------------
//e_CmdK10_SetRTCTime=23,//                     St_K10_RTCTime                        void 
struct __attribute__((__packed__)) TAG_St_K10_RTCTime  
...
typedef struct __attribute__((__packed__)) TAG_St_K10_RTCTime St_K10_RTCTime;
