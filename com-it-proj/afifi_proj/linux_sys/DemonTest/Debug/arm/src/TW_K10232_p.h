#ifndef TW_K10232_P_H_
#define TW_K10232_P_H_
/*
 * TW_K10232_p.h
 *
...
typedef struct TAG_St_K10_TestComm St_K10_TestComm;
...
typedef struct TAG_St_K10_BITResult St_K10_BITResult;
...
typedef struct TAG_St_K10_DisplaySet St_K10_DisplaySet;
...
typedef struct TAG_St_K10_DisplayGet St_K10_DisplayGet;
...
typedef struct TAG_St_K10_PowerCommandGet St_K10_PowerCommandGet;
...
typedef struct TAG_St_K10_PowerCommandSet St_K10_PowerCommandSet;
...
typedef struct TAG_St_K10_SensorCommandGet St_K10_SensorCommandGet;
...
typedef struct TAG_St_K10_SolenoidCommandSet St_K10_SolenoidCommandSet;
...
typedef struct TAG_St_PrinterCommandSet St_PrinterCommandSet;
...
typedef struct TAG_St_K10_LedCommandSet St_K10_LedCommandSet;
...
typedef struct TAG_St_K10Param St_K10Param;
...
typedef struct TAG_St_K10_EventSensorChange St_K10_EventSensorChange;
...
typedef struct TAG_St_K10_GetAppVersion St_K10_GetAppVersion;
//-------------------------------------------------------------------
...
typedef struct TAG_St_K10_DownLoad St_K10_DownLoad;
...
typedef struct TAG_St_K10_RTCTime St_K10_RTCTime;
